    ...
    if file is not None:
        ...
        for decimal in df['Decimals']:
            ...
            if fraction.numerator > fraction.denominator:
                whole_num = fraction.numerator // fraction.denominator
                numerator = fraction.numerator - whole_num * fraction.denominator
                fraction_str = f"{whole_num} {numerator}/{fraction.denominator}\"" if numerator != 0 else f"{whole_num}\""
            else:
